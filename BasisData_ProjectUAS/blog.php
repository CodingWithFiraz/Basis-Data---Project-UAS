...
<div class="blog-list row">
  ...
  <div class="col-md-4">
    ...
    <p>Membaca bersama mempererat hubungan anak dan orang tua. Temukan buku-buku seru dan edukatif yang bisa dinikmati bersama, sambil menumbuhkan kecintaan membaca sejak dini.</p>
  ...
  <div class="col-md-4">
    ...
    <p>Beragam kisah cinta untuk dinikmati — dari yang lucu, aneh, mendalam, hingga tragis. Temukan cerita yang sesuai dengan seleramu!</p>
    <a href="#">Baca seluruh post</a>
    </div>
...
<div class="blog-list row">
  <div class="col-md-4">
    ...
    <p>Merekomendasi buku yang dapat membantu mahasiswa mengembangkan keterampilan kolaborasi dalam perkuliahan. Dari teknik komunikasi efektif hingga manajemen tim</p>
    <a href="#">Baca seluruh post</a>
    </div>
  ...
  <div class="col-md-4">
    ...
    <p>temukan cara membaca buku jenis ini dengan lebih mendalam dan menikmati pengalaman literasi yang lebih introspekti</p>
    <a href="#">Baca seluruh post</a>
    </div>
  ...
  <div class="col-md-4">
    ...
    <p>Alumni Universitas Indonesia telah meraih prestasi membanggakan di berbagai bidang. Simak kisah-kisah inspiratif mereka yang membawa perubahan positif dan menginspirasi banyak orang.</p>
    <a href="#">Baca seluruh post</a>
    </div>
